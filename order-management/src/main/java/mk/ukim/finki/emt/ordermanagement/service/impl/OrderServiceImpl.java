...
public class OrderServiceImpl implements OrderService {
    ...
    public void addItem(OrderId orderId, OrderItemForm orderItemForm) throws OrderIdNotExistException {
        ...
        order.addItem(orderItemForm.getProduct(), orderItemForm.getUser(), orderItemForm.getAddress(), orderItemForm.getQuantity());
    ...
    private Order toDomainObject(OrderForm orderForm) {
        ...
        orderForm.getItems().forEach(item->order.addItem(item.getProduct(), item.getUser(), item.getAddress(), item.getQuantity()));
        return order;
    }
}
